...
class CodeOutputTask(BaseTask):
    ...
    def check_correctness(
        ...
        # Check for abstention_verify format: </verify>\s*<commit> or <abstain>
    ...
    def _categorize_result(self, r: dict) -> str:
        ...
        # If commit/abstain keys exist but both are False → incomplete
    ...
    def compute_metrics(self, results: list[dict]) -> dict:
        ...
        When results use commit/abstain format, also computes precision/recall/F1.
        """
        ...
        # Commit/abstain precision/recall/F1
        ...
        if commit_stats:
            ...
            if commit_by_variant:
                lines.extend([
                    ...
                    f"  {'Variant':<16} {'Commit+Cor':>12} {'Commit+Wrg':>12} {'Abst+Wrg':>12} {'Abst+Cor':>12} {'Incomplete':>12}",
                    "  " + "-" * 76,
                ])
                variant_order = ["short", "medium", "long"]
                for variant in [v for v in variant_order if v in commit_by_variant] + sorted(set(commit_by_variant) - set(variant_order)):
                    d = commit_by_variant[variant]
                    lines.append(
                        f"  {variant:<16} {d['commit_correct']:>12} {d['commit_wrong']:>12} {d['abstain_wrong']:>12} {d['abstain_correct']:>12} {d['incomplete']:>12}"
                    )
