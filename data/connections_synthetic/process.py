...
from data.prompt_loader import load_jsonl_example, generate_connections_3x3_prompt
...
def extract_answer(text: str, variant: str = "3x3"):
...
def main():
    ...
    connections_path = DATASETS_DIR / "connections_synthetic" / "train.jsonl"
    output_path = DATASETS_DIR / "connections_synthetic" / "generations_3x3.jsonl"
